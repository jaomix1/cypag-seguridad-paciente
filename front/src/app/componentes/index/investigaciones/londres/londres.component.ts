...
export class LondresComponent implements OnInit {
  ...
  form = new FormGroup({
    ...
    Fase1_Medio_Observaciones: new FormControl('', [Validators.maxLength(2500), Validators.required]),
    Fase1_Cronologia: new FormControl('', [Validators.maxLength(5000), Validators.required]),
