...
@Component({
  selector: 'app-eps-editar',
  templateUrl: './epsEditar.component.html',
  styleUrls: ['./epsEditar.component.scss'],
})
export class EpsEditarComponent extends BaseFormComponent implements OnInit {
  datos: Eps = new Eps();
