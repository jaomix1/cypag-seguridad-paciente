...
import { ComboText, ComboTextChecked } from 'src/app/modelos/combos/combo';
...
export class CombosLondresService {
  ...
  arrayOptions = [
    ...
    {
      type: 5,
      option: 'Flebitis mecánica'
    },
    {
      type: 5,
      option: 'Flebitis química'
    },
    {
      type: 5,
      option: 'Flebitis bacteriana'
    },
    {
      type: 5,
      option: 'Extravasacion'
    },
    {
      type: 5,
      option: 'Infiltracion'
    ...
    {
      type: 12,
      option: 'Lesion por presión [Ulceras por presión]'
    },
    {
      type: 12,
      option: 'Ulceras en piel por presión de dispositivos'
    },
    {
      type: 12,
      option: 'Lesion cutánea asociada a la humedad (LESCAH)'
    },
    {
      type: 12,
      option: 'Lesion cutánea asociada a adhesivos'
    },
    {
      type: 12,
    ...
    {
      type: 16,
      option: 'Presentación y embalaje deficientes'
    },
    {
      type: 16,
      option: 'Falta de disponibilidad'
  ...
  public fase1_medios: ComboTextChecked[] = [
    {
