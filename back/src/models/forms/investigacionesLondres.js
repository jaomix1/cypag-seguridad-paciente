...
InvestigacionesLondresModel.init(
  {
    ...
    Fase1_Medio_Observaciones: { type: DataTypes.STRING(2500), allowNull: true },
    Fase1_Cronologia: { type: DataTypes.STRING(5000), allowNull: true },
    ...
    Fase2_Analisis_Problema: { type: DataTypes.STRING(500), allowNull: true },
