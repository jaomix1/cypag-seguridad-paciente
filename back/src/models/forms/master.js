...
MasterModel.init(
  {
    ...
    Servicio_Id: { type: DataTypes.INTEGER, allowNull: true },
    Otro_Servicio: { type: DataTypes.STRING(300), allowNull: true },
    ...
    EdadMeses: { type: DataTypes.BOOLEAN, allowNull: true },
    Tipo_Novedad: { type: DataTypes.INTEGER, allowNull: false },
    Preg_Que: { type: DataTypes.STRING(1500), allowNull: false },
    Preg_Como: { type: DataTypes.STRING(1500), allowNull: false },
    Preg_Hay_Testigos: { type: DataTypes.BOOLEAN, allowNull: false },
    Preg_Quien: { type: DataTypes.STRING(1500), allowNull: false },
    ...
    Preg_Dano_Generado: { type: DataTypes.STRING(1500), allowNull: false },
    Preg_Dano_Severidad: { type: DataTypes.STRING(20), allowNull: false },
    Accion_Tomada: { type: DataTypes.STRING(1500), allowNull: true },
